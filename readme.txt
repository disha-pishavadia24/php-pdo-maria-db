step 1).
create database named "php_pdo_mariadb" from phpMyadmin slecting a server MariaDB

step 2).
run below sql query in phpMyAdmin
--
...
step 3).
to dump some data in table run below sql query in phpMyAdmin
--
